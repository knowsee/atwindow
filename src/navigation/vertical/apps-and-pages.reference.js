// Reference backup of previous full menu.
// This file is not used by runtime navigation.
export default [
  { heading: 'Apps & Pages' },
  {
    title: '打印标签',
    ...
    children: [
      { title: '新建', to: 'apps-print-label-create' },
      { title: '运单列表', to: 'apps-print-label-orders' },
    ],
  },
  {
    title: '一件代发',
    ...
    children: [
      { title: '产品管理', to: 'apps-drop-shipping-products' },
    ],
  },
  {
    title: '账户管理',
    ...
    children: [
      { title: '个性化配置', to: 'apps-account-personalization' },
      { title: '授权管理', to: 'apps-account-auth-management' },
      { title: '资金管理', to: 'apps-account-fund-overview' },
    ],
  },
  {
    title: 'Ecommerce',
